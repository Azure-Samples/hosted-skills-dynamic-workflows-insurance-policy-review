...
resource foundryProject 'Microsoft.CognitiveServices/accounts/projects@2025-10-01-preview' = {
  ...
  properties: {
    ...
    description: 'Dynamic Workflows insurance policy review sample'
  }
}
...
resource appCognitiveServicesUserRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
...
resource appOpenAiUserRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
...
resource deployerCognitiveServicesUserRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (!empty(deployerPrincipalId)) {
